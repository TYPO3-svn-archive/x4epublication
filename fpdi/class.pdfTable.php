...
//    var $evenColor = array(223,236,218);
    ...
    function pdfTable($oriantation='P', $unit='mm', $format='A4') {
        parent::fpdi($oriantation, $unit, $format);
    }
    ...
    /**
     * Überschreibt die Header-Methode von FPDF und ruft die
    ...
    /**
     * Überschreibt die Footer-Methode von FPDF und ruft die
    ...
    /**
     * Beendet die Tabelle und setzt diverse Statusflags zurück.
     *
     * @return boolean
     */
    function EndTable() {
